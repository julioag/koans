...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # it's like a reduce function, it iterates with the initial value of inject and the array, then with the result make another function call with the second element and so on.
  end
